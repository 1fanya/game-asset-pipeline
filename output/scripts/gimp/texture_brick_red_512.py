#!/usr/bin/env python
# GIMP Python-Fu: Texture Pipeline for brick_red @ 512px
# Usage: gimp -i -b 'python-fu-eval -s "output/scripts/gimp/texture_brick_red_512.py"' -b '(gimp-quit 0)'
from gimpfu import *

def process_brick_red():
    img = pdb.gimp_file_load("output/textures/brick_red_512.png", "output/textures/brick_red_512.png")
