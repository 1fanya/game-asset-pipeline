#!/usr/bin/env python
# GIMP Python-Fu: Texture Pipeline for fabric_cloth @ 1024px
# Usage: gimp -i -b 'python-fu-eval -s "output/scripts/gimp/texture_fabric_cloth_1024.py"' -b '(gimp-quit 0)'
from gimpfu import *

def process_fabric_cloth():
    img = pdb.gimp_file_load("output/textures/fabric_cloth_1024.png", "output/textures/fabric_cloth_1024.png")
