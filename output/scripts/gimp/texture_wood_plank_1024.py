#!/usr/bin/env python
# GIMP Python-Fu: Texture Pipeline for wood_plank @ 1024px
# Usage: gimp -i -b 'python-fu-eval -s "output/scripts/gimp/texture_wood_plank_1024.py"' -b '(gimp-quit 0)'
from gimpfu import *

def process_wood_plank():
    img = pdb.gimp_file_load("output/textures/wood_plank_1024.png", "output/textures/wood_plank_1024.png")
