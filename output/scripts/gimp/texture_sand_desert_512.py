#!/usr/bin/env python
# GIMP Python-Fu: Texture Pipeline for sand_desert @ 512px
# Usage: gimp -i -b 'python-fu-eval -s "output/scripts/gimp/texture_sand_desert_512.py"' -b '(gimp-quit 0)'
from gimpfu import *

def process_sand_desert():
    img = pdb.gimp_file_load("output/textures/sand_desert_512.png", "output/textures/sand_desert_512.png")
